...
public class VerificationToken {
    ...
    public boolean deepEquals(Object obj) {
        ...
        if (obj == null || getClass() != obj.getClass()) return false;
        VerificationToken verificationToken = (VerificationToken) obj;
        return this.id==verificationToken.id && this.token.equals(verificationToken.token)
                && this.user.equals(verificationToken.user)
                && this.expiryDate.getTime()==verificationToken.expiryDate.getTime();
    }
}